...
# -*- coding: utf-8 -*-
#
# ReadTheDocs-Breathe documentation build configuration file based, created by
...
if on_rtd:
  ...
  call('cd .. ; doxygen Doxyfile WORKING_DIRECTORY ..', shell=True)
  call('echo "Cat index:"', shell=True)
  call('cat doxyxml/index.xml', shell=True)
...
breathe_projects = { "libdt": "doxyxml/" }
breathe_default_project = "libdt"
...
project = 'libdt'
copyright = 'Copyright (c) 2013, EPAM Systems. All rights reserved.'
